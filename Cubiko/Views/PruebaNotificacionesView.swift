...
//    
//    @State private var viewModel = ReservaViewModel(reservaActiva:  Reserva(id: 1, estudianteId: 1, salaUbicacion: "Biblioteca", salaNumero: 1, fechaInicio: Date().addingTimeInterval(3 * 60 * 60), fechaFin: Date().addingTimeInterval(5 * 60 * 60), horaInicio: DateComponents(hour: 8, minute: 0, second: 0), horaFin: DateComponents(hour: 13, minute: 0, second: 0), numPersonas: 1))
//    
//    
...
//                        Button {
//                            filaExpandida = ""
//                            let cubiculoPrueba = SalaDisponible(numero: 2, ubicacion: "Biblioteca Central", maxPersonas: 2, minPersonas: 4)
//                            mensajeError = viewModel.crearReserva(sala: cubiculoPrueba, inicio: fechaInicio, fin: fechaFin)
//                        } label: {
